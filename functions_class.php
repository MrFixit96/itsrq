...
##############################################################################################
#                          html_idclass FUNCTION - CSS EMEMENT SELECTOR                           #
#                                                                                            #
...
#      //     sent to html_idclass css element function and will insert that                      #
#                                                                                            #
##############################################################################################
function anchor($link,$display,$css=""){
  if ($link != "" && $display != ""){
    echo "<a ", $this->html_idclass($css), " href=\"$link\" >$display</a>";//spaces indent tags inside of html
  }//end if not nothing
  else{
...
function abbr($title = "",$abbr="", $css=""){
  echo "  <abbr ", $this->html_idclass($css), "title=\"$title\">$abbr</abbr>\n";//spaces indent tags inside of html
}//end function
##############################################################################################
#                                     ACRONYM Tag                                            #
##############################################################################################
function acron($title = "",$acron="", $css=""){
  echo "  <acronym ", $this->html_idclass($css), "title=\"$title\">$acron</acronym>\n";//spaces indent tags inside of html
}//end function
##############################################################################################
#                                     ADDRESS Tag                                            #
#                                                                                            #
...
function bold($text, $css=""){
  echo "  <b ", $this->html_idclass($css), ">$text</b>";
}//end function
##############################################################################################
#                                     B Start Tag                                            #
...
function big($text, $css=""){
  echo "<big ", $this->html_idclass($css), ">$text</big>";
}//end function
##############################################################################################
#                                     BIG Start Tag                                          #
#  //used for bolding, but you shouldnt use it. Use CSS styling instead                      #
...
function big_beg($css=""){
  echo "  <big ", $this->html_idclass($css), ">";
}//end function
##############################################################################################
#                                     BIG End Tag                                            #
#  //used for bolding, but you shouldnt use it. Use CSS styling instead                      #
...
function blockquote($text, $css = ""){
  echo "  <blockquote ", $this->html_idclass($css), ">\n    $text\n  </blockquote>\n";
}//end function
##############################################################################################
...
function caption($text="", $css=""){
  echo "  <caption ", $this->html_idclass($css), ">$text</caption>\n";
}//end function
##############################################################################################
#                                     CITE Tag                                               #
#                                                                                            #
...
function cite($text="", $css=""){
  echo "  <cite ", $this->html_idclass($css), ">$text</cite>\n";
}//end function
##############################################################################################
#                                     CODE Tag                                               #
#                                                                                            #
...
function code($text="", $css=""){
  echo "  <code ", $this->html_idclass($css), ">$text</cite>\n";
}//end function
##############################################################################################
#                                     DEL Tag                                                #
...
function del($text="", $css=""){
  echo "  <del ", $this->html_idclass($css), ">$text</del>\n";
}//end function
##############################################################################################
#                                 <DIV> DIVISION BEGINNING TAG                               #
##############################################################################################
function div_beg($css=""){
  echo "  <div ", $this->html_idclass($css), ">\n";//spaces indent tags inside of html
}//end function
##############################################################################################
...
function dd($text="", $css=""){
  echo "  <dd ", $this->html_idclass($css), ">$text</dd>\n";
}//end function
##############################################################################################
#                                DFN Tag                                                     #
...
function dfn($text="", $css=""){
  echo "  <dfn ", $this->html_idclass($css), ">$text</dfn>\n";
}//end function
##############################################################################################
#                                     DT Tag                                                 #
#                                                                                            #
...
function dt($text="", $css=""){
  echo "  <dt ", $this->html_idclass($css), ">$text</dt>\n";
}//end function
...
function em($text, $css = ""){
  echo "  <em ", $this->html_idclass($css), ">$text</em>";
}//end function
##############################################################################################
#                                     EM Begining Tag                                        #
...
function fieldset_beg($css=""){
  echo "  <fieldset ", $this->html_idclass($css), ">\n";
}//end function
##############################################################################################
#                                     FIELDSET Ending Tag                                    #
##############################################################################################
...
function font_beg($color="", $face="", $size="", $css=""){
  echo "  <font ", $this->html_idclass($css), " color=\"$color\" face=\"$face\" size=\"$size\">";
}//end function
##############################################################################################
#                                     FONT Ending Tag                                        #
##############################################################################################
...
function form_beg(){
  ...
  if ($attributes[0] !== null){
    echo "  <form", $this->form_attr($attributes) ,">\n";
  }//end if
  else{
    echo "  <form>\n";
  }//end else
...
function form_attr($attributes){
  foreach ($attributes as $value){
    ...
    echo $this->args_switch_form_attributes($sel, $val);
  }//end foreach
}//end function
...
function frm_input(){
  $attributes = func_get_args();
  if ($attributes[0] !== null){
    echo "  <input", $this->input_attr($attributes) ," />\n";
  }//end if
  else{
    echo "  <input>\n";
  }//end else
...
function input_attr($attributes){
  foreach ($attributes as $value){
    $sel = substr($value, 0, 3);
    $val = substr($value, 3, (strlen($value)-3));
    echo $this->args_switch_input_attributes($sel, $val);
  }//end foreach
}//end function
...
function frm_textarea(){
  $attributes = func_get_args();
  if ($attributes[0] !== null){
    echo "  <textarea", $this->textarea_attr($attributes) ,">\n";
  }//end if
  else{
    echo "  <textarea>\n";
  }//end else
...
function textarea_attr($attributes){
  foreach ($attributes as $value){
    $sel = substr($value, 0, 3);
    $val = substr($value, 3, (strlen($value)-3));
    echo $this->args_switch_textarea_attributes($sel, $val);
  }//end foreach
}//end function
...
function frm_button(){
  $attributes = func_get_args();
  if ($attributes[0] !== null){
    echo "  <button", $this->button_attr($attributes) ,">\n";
  }//end if
  else{
    echo "  <button>\n";
  }//end else
...
function button_attr($attributes){
  foreach ($attributes as $value){
    $sel = substr($value, 0, 3);
    $val = substr($value, 3, (strlen($value)-3));
    echo $this->args_switch_button_attributes($sel, $val);
  }//end foreach
}//end function
...
function frm_select(){
  $attributes = func_get_args();
  if ($attributes[0] !== null){
    echo "  <select", $this->select_attr($attributes) ,">\n";
  }//end if
  else{
    echo "  <select>\n";
  }//end else
...
function select_attr($attributes){
  foreach ($attributes as $value){
    $sel = substr($value, 0, 3);
    $val = substr($value, 3, (strlen($value)-3));
    echo $this->args_switch_select_attributes($sel, $val);
  }//end foreach
}//end function
...
function frm_optgroup(){
  $attributes = func_get_args();
  if ($attributes[0] !== null){
    echo "  <optgroup", $this->optgroup_attr($attributes) ,">\n";
  }//end if
  else{
    echo "  <optgroup>\n";
  }//end else
...
function optgroup_attr($attributes){
  foreach ($attributes as $value){
    $sel = substr($value, 0, 3);
    $val = substr($value, 3, (strlen($value)-3));
    echo $this->args_switch_optgroup_attributes($sel, $val);
  }//end foreach
}//end function
...
function frame_beg($frameborder="", $longdesc="", $marginheight="", $marginwidth="",
  ...
  echo "  <frame ", $this->html_idclass($css), " frameborder=\"$frameborder\" longdesc=\"$longdesc\" marginheight=\"$marginheight\" marginwidth=\"$marginwidth\" name=\"$name\" noresize=\"$noresize\" scrolling=\"$scrolling\" src=\"$src\">\n";
}//end function
##############################################################################################
#                                     FRAME Ending Tag                                       #
##############################################################################################
...
function frameset_beg($cols="", $rows="", $css=""){
  echo "  <frameset ", $this->html_idclass($css), " cols=\"$cols\" rows=\"$rows\">\n";
}//end function
##############################################################################################
#                                     FRAMESET Ending Tag                                    #
##############################################################################################
...
function heading_beg($number="", $css=""){
  if ($number >=1 && $number <=6){
    echo "  <h$number ", $this->html_idclass($css), ">";
  }else{
     //do nothing
 } //end if
}//end function
...
function iframe_beg($frameborder="", $height="", $longdesc="", $marginheight="", $marginwidth="",
  ...
  echo "  <iframe ", $this->html_idclass($css), " frameborder=\"$frameborder\" height=\"$height\" longdesc=\"$longdesc\" marginheight=\"$marginheight\" marginwidth=\"$marginwidth\" name=\"$name\" width=\"$width\" scrolling=\"$scrolling\" src=\"$src\">\n";
}//end function
##############################################################################################
#                                     IFRAME Ending Tag                                      #
##############################################################################################
...
function img($alt="", $src="", $height="", $ismap="", $longdesc="",
     $usemap="", $width="", $css=""){
  echo "  <img ", $this->html_idclass($css), " frameborder=\"$frameborder\" height=\"$height\" longdesc=\"$longdesc\" marginheight=\"$marginheight\" marginwidth=\"$marginwidth\" name=\"$name\" width=\"$width\" scrolling=\"$scrolling\" src=\"$src\" />\n";
}//end function
##############################################################################################
#                                    INS TAG                                                 #
...
#                                                                                            #
#      //Input is for css elements, it calls html_idclass function. reference html_idclass             #
#                                                                                            #
##############################################################################################
function ul_beg($css){
  echo "  <ul ", $this->html_idclass($css), ">\n";//spaces indent tags inside of html
}//end function
##############################################################################################
...
function span_beg($css=""){
  echo "  <span ", $this->html_idclass($css), ">\n";//spaces indent tags inside of html
}//end function
##############################################################################################
...
function p_text($text = "", $css = ""){
  echo "  <p", $this->html_idclass($css), ">$text</p>\n"; //spaces indent tags inside of html
}//end function
##############################################################################################
