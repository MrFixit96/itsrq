...
'''''''''''''''''''''
' Messages
Const L_ConfImported_Text       = "Configuration imported from %1 in file %2 to %3 in the Metabase."
...
Const L_Help_HELP_General13_Text = "                        /copy       Copy configuration from one machine to"
Const L_Help_HELP_General14_Text = "                                    another."
...
' Copy help messages
Const L_Help_HELP_Copy1_Text      = "Description:  Copy configuration from a source server to a target server."
Const L_Help_HELP_Copy2_Text      = "Syntax:  iiscnfg [/s <server>] [/u <username> [/p <password>] ] /copy  /ts <target server> /tu <target user> /tp <target password>"
Const L_Help_HELP_Copy3_Text      = "Parameters:"
Const L_Help_HELP_Copy4_Text      = "Value		           Description"
Const L_Help_HELP_Copy5_Text      = "/s <server>           Connect to machine <server> [Default: this system]"
Const L_Help_HELP_Copy6_Text      = "/u <username>         Connect as <username> or <domain>/<username>"
Const L_Help_HELP_Copy7_Text      = "                      [Default: current user]"
...
Const L_Help_HELP_Copy10_Text     = "/tu                   Username to use when connecting to the target server"
Const L_Help_HELP_Copy11_Text     = "/tp                   Password to use when connecting to the target server"
...
Const L_Help_HELP_Copy14_Text     = "iiscnfg.vbs /s SourceServer /u Administrator /p Kj30W /copy /ts TargetServer /tu Administrator /tp Pk$^j"
...
Const L_Help_HELP_Save02_Text   = "Syntax:  iiscnfg [/s <server>] [/u <username> [/p <password>] /save"
...
Function Import(strDecPass, strFile, strSourcePath, strDestPath, intFlags)
    ...
    oCmdLib.vbPrintf L_ConfImportedText, Array(strSourcePath, strFile, strDestPath)
End Function
