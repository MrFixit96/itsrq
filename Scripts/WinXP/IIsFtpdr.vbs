...
Const L_CannotGetVDir_ErrorMessage        = "Either the path specified does not exist or it is not an FTP virtual directory.  Please make sure the path specified is valid."
