...
Const L_VDirDoesntExist_ErrorMessage      = "Either the path specified is not an IIsVirtualDir object or the path does not exist (%1)"
...
Const L_CannotGetVDir_ErrorMessage        = "Either the path specified does not exist or it is not a virtual directory.  Please make sure the path specified is valid."
